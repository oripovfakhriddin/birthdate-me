    ...
    <Fragment>
      {loading ? (
        ...
        <Fragment>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {search ? (
                      <button
                        ...
                        type="button"
                        className="absolute transition duration-300 p-1 end-24 bottom-2.5 text-red-500 rounded-lg  bg-blue-700 hover:bg-blue-800 dark:text-red-500  focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        aria-expanded="false"
                      >
          ...
          <UsersTableForAdmin users={users} refetch={refetch} />
          <nav
                    ...
                    <li key={index}>
                      <button
                        ...
                        className={`flex items-center rounded justify-center px-3 h-8 transition-all duration-300 border border-gray-300  hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-400 dark:border-gray-700 dark:bg-gray-700 dark:text-white ${
                          +currentPage === value
                            ? "!text-blue-600 !bg-blue-100 dark:!text-white dark:!bg-blue-600"
                            : null
                        }`}
                      >
                        {value}
